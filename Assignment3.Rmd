...
```{r}
#HELPPP TA WHERE DO WE SUBTRACT 33 / DO WE NEED TO???
Xchrom <- sam[sam$V3 == "X", ]

bq_int_x <- sapply(Xchrom$V11, utf8ToInt)
...
bq_int <- sapply(sam$V11, utf8ToInt)
...
*61,527 reads.*
```{r}
#*** CONFIRM ITS OUT OF THE WHOLE SAM FILE, NOT CHROMOSOME 9
...
next steps:
- finish q5 separately
- mona ask q4 subquestions on piazza
- mona should upload her code so far (and for mutation analysis)
- traye and maya align with the team code 

- friday ~5pm compare q5 
- 5:30-7:30 friday OH (all free!) to ask q4.5 !!! and possibly q5 remaining 
